...
export default function Header() {
    ...
    return (
        ...
        <Disclosure
            as="nav"
            className="bg-[#f6f6f3] relative after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10 funnel-sans-light"
        >
            <div className="mx-auto max-w-7xl px-4  lg:px-8 block justify-center sm:px-6 sm:flex">
                <div className="relative h-30 justify-between">
                    ...
                    <div className="flex flex-1 sm:justify-center  mb-4 items-center sm:items-stretch">
                        <div className='p-2 mt-2 sm:mt-0 sm:p-0 flex-shrink-0 flex items-center'>
